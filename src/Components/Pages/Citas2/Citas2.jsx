                  ...
                  <div className='w-[90%] flex justify-evenly flex-wrap'>
                    {selectedService ? (
                      ...
                      <>
                        ...
                        <div className='w-1/5 mx-2 flex flex-col items-center rounded-full p-5 justify-center hover:-translate-y-4 hover:bg-emerald-950 duration-500 ' onClick={() => handleServiceSelect('Peluqueria')}>
                          ...
                          <p className='text-3xl'>Peluqueria</p>
                        </div>

                        <div className='w-1/5 mx-2 flex flex-col items-center rounded-full p-5 justify-center hover:-translate-y-4 hover:bg-emerald-950 duration-500 ' onClick={() => handleServiceSelect('Guarderia')}>
                          ...
                          <p className='text-3xl'>Guarderia</p>
                        </div>
                      </>
