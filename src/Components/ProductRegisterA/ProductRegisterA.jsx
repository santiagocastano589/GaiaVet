...
const ProductRegisterA = ({edad,peso, namePet, documento, tipo, raza, onClose }) => {
  ...
  return (
    <div className="w-full fixed z-50 inset-0 overflow-y-auto bg-slate-50 border bg-opacity-75 transition-all ease-in-out duration-300">
      ...
      <div className="w-[75rem] h-[32rem] relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  bg-fondo  rounded-lg shadow-sm">

      <div className='w-full flex justify-between items-center border bg-slate-300'>
        
        <div className="w-[80%] p-4 text-white flex flex-col items-center ">

          <InputPetNoEditable htmlFor="nombre" nameLabel="Nombre del producto:" id="nombre" value={editedName} onChange={handleNameChange}/>
        ...
        <div className="h-[32rem] w-[35%] bg-fondoTarjeta rounded-lg">
...
export default ProductRegisterA;
