...
export const ContainerLocation = ({ direction, phone, image, alt}) => {
  return (
    <div className='w-full mt-6 pb-24 py-8 text-white'>
        <div className='w-full h-60 bg-teal-600 flex flex-row justify-evenly items-center sm:w-[57rem] sm:mt-80 md:mt-72 lg:w-[100vw] xl:mt-3'>
            <div className='w-1/3 h-56 flex flex-col justify-evenly text-2xl sm:w-[20rem]'>
