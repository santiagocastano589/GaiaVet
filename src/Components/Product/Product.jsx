...
export const Product = ({id, image, title, alt, description, price}) => {
  return (
    <>
    
    <div key={id} className="w-[20rem] h-full m-4 rounded-xl flex flex-col justify-between items-center shadow-md border bg-slate-50 px-2 py-6">
