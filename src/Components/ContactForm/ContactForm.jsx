...
export const ContactForm = () => {
  return (
    <div className='w-full pb-20 flex justify-evenly h-auto'>
        <form action="" className='bg-white rounded-xl shadow-formShadow ml-10 w-auto h-auto flex flex-col items-center py-5 px-20 sm:w-[290rem] sm:mt-10'>
        ...
        <div className='w-1/2 flex justify-center'>
            <img src={collage} alt="" className='w-1/2  sm:hidden' />
        </div>    
    </div>
  )
}
